import 'dart:convert';
import 'package:bacaan_sholat/model/model_wudhu.dart';
...
class Wudhu extends StatefulWidget {
  ...
  @override
  _WudhuState createState() => _WudhuState();
}

class _WudhuState extends State<Wudhu> {
  Future<List<ModelWudhu>> ReadJsonData() async {
    final jsondata =
        await rootBundle.rootBundle.loadString('assets/data/wudhu.json');
                    ...
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Tata Cara Wudhu dari awal sampai akhir",
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 12,
                                  fontWeight: FontWeight.bold),
